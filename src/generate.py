...
def print_loop():
    ...
    loopfile.write('// #############\n')
    loopfile.write('\n')
    loopfile.write('loop_vars pre_loop(std::string parameter, float val, int suite_code, loop_vars prevars, QIE10DataFrame digis, int nCH, int _event_num, TQIE10Info &_qie10Info, TTree** _trees, vector<TH1F*> &TH1F_perEVs, vector<vector<TH1F*> > &TH1F_perCHs, vector<vector<vector<TH1F*> > > &TH1F_PerTSs, vector<TH2F*> &TH2F_perEVs, vector<vector<TH2F*> > &TH2F_perCHs, vector<vector<vector<TH2F*> > > &TH2F_PerTSs, vector<vector<TH2F*> > &TProfiles, ofstream *loggers) {\n')
    loopfile.write('\n')
    for s in range(len(suites)):
        loopfile.write('// --- Suite ' + suites[s][0] + ': ' + suites[s][1] + ' ---\n')
        loopfile.write('\n')
    ...
    loopfile.write('// #########\n')
    loopfile.write('\n')
    loopfile.write('loop_vars loop(std::string parameter, float val, int suite_code, loop_vars prevars, QIE10DataFrame digis, int nTS, int nCH, int _event_num, TQIE10Info &_qie10Info, TTree** _trees, vector<TH1F*> &TH1F_perEVs, vector<vector<TH1F*> > &TH1F_perCHs, vector<vector<vector<TH1F*> > > &TH1F_PerTSs, vector<TH2F*> &TH2F_perEVs, vector<vector<TH2F*> > &TH2F_perCHs, vector<vector<vector<TH2F*> > > &TH2F_PerTSs, vector<vector<TH2F*> > &TProfiles, ofstream *loggers) {\n')
    loopfile.write('\n')
    for s in range(len(suites)):
        loopfile.write('// --- Suite ' + suites[s][0] + ': ' + suites[s][1] + ' ---\n')
        loopfile.write('\n')
    ...
    loopfile.write('// ##############\n')
    loopfile.write('\n')
    loopfile.write('loop_vars post_loop(std::string parameter, float val, int suite_code, loop_vars prevars, QIE10DataFrame digis, int nCH, int _event_num, TQIE10Info &_qie10Info, TTree** _trees, vector<TH1F*> &TH1F_perEVs, vector<vector<TH1F*> > &TH1F_perCHs, vector<vector<vector<TH1F*> > > &TH1F_PerTSs, vector<TH2F*> &TH2F_perEVs, vector<vector<TH2F*> > &TH2F_perCHs, vector<vector<vector<TH2F*> > > &TH2F_PerTSs, vector<vector<TH2F*> > &TProfiles, ofstream *loggers) {\n')
    loopfile.write('\n')
    for s in range(len(suites)):
        loopfile.write('// --- Suite ' + suites[s][0] + ': ' + suites[s][1] + ' ---\n')
        loopfile.write('\n')
